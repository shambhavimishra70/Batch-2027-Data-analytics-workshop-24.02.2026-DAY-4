...
2. if don't know to upload please ask your friends how to upload file
3. When you open the this repo at right side you can see the fork option click on fork 
4. Create a fork 
5. Now go to add file then click on create new file 
6. Create new file first name it with your name_roll.no/ 
